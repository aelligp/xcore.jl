...
mutable struct DyrelCache{T<:AbstractFloat, A<:AbstractMatrix{T}}
    ...
    s_P::A            # Schur-complement diagonal ≈ Σ_faces (ρ_f/D_f)/(h²ρ): the
                      # locally-optimal Powell-Hestenes pressure-update scale.
                      # Pressure update is P += ω·R_P/s_P (grid/inertia-adaptive),
                      # replacing the hand-tuned constant γ_eff·R_P.
